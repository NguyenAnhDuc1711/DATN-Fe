...
export const localeMap = {
  "en-FJ": "Fiji",
  "sw-TZ": "Tanzania",
  "ar-EH": "W. Sahara", // Assuming Arabic as widely spoken
  "en-CA": "Canada",
...
export const localeToCountry = (locale) => {
  return localeMap[locale] || "Country not found";
};

export const getLocaleId = (country) => {
  const countryInfo = Object.entries(localeMap).find(
    ([_, name]) => name === country
  );
  if (countryInfo) {
